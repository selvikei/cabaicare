...
class PestGridSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      // Padding horizontal agar kartu tidak benar-benar menempel ke pinggir layar
      padding: const EdgeInsets.symmetric(horizontal: 0),
      child: Row(
        // Ini yang bikin kartu paling kiri mepet kiri, paling kanan mepet kanan
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: const [
          Expanded(child: PestCard(name: "Kutu Daun")),
          SizedBox(width: 10), // Jarak antar kartu
          Expanded(child: PestCard(name: "Kutu Kebul")),
          SizedBox(width: 10), // Jarak antar kartu
          Expanded(child: PestCard(name: "Thrips")),
        ],
      ),
    );
  }
